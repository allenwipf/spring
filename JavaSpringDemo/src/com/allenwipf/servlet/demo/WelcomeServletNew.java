package com.allenwipf.servlet.demo;
...
import com.allenwipf.service.demo.WelcomeService;
...
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 1. Create the data (model) and add the request object
		// Invoking business layer
		
		WelcomeService welcomeService = new WelcomeService();
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Allen Wipf");
